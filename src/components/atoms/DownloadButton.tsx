...
import { cn } from "@/lib/utils"; // gunakan helper merge class jika kamu sudah punya
...
export const DownloadButton: React.FC<ButtonProps> = ({
  ...
  const variants: Record<ButtonVariant, string> = {
    ...
    secondary:
      "bg-transparent  border-[1px] border-white-mineral hover:border-charcoal-green-dark hover:bg-charcoal-green-dark hover:text-white-mineral",
    outline:
